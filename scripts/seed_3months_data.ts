async function seedViaRestApi() {
  ...
  const employeeSeeds = [
    { name: "Rahul MDZ", email: "owner@esscompany.com", role: "OWNER", designation: "Founder & CEO", department: "Executive Management", salaryMonthly: 250000, skills: ["Leadership", "Strategy", "Finance"] },
