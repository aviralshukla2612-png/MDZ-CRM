...
async function main() {
  console.log("🧹 Starting database cleanup: removing all dummy data and keeping only Super Admin...");

  // 1. Delete all transactional, project, client, and lead data
  ...
  console.log("✓ Removed all projects, leads, clients, invoices, attendance, and activity records.");
